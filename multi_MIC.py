...
def pre_main(path='/public/home/hwj/zh/multi_MIC/'):
	main = pre(path)
	#main.load_data()
...
if __name__ == '__main__':
	pre_main()
	main = trainer(path='/public/home/hwj/zh/multi_MIC/', lr=0.001, batch_size=128, epochs=1000, out=1, _type='classify', class_weight=None)
	main.main_trainer()
